  ...
  return (
    <>
      <div className="relative bg-gradient-to-br from-white to-blue-0 rounded-lg shadow-lg overflow-hidden transition-all duration-300 hover:shadow-xl border border-blue-100 transform hover:-translate-y-1">
        ...
        {/* Content container */}
        <div className="relative z-10 py-6 px-4 sm:p-8">
          {/* Main Content */}
          <div className="mb-8">
            <div className="flex flex-col md:flex-row  md:items-center justify-between gap-6">
              <div className="">
                <div className="w-auto p-1 h-12 sm:h-14 flex-shrink-0 overflow-hidden ">
                  <img
          ...
          {/* Profile */}
          <div className="flex flex-col gap-4 sm:flex-row items-between">
